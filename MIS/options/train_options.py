...
def get_options():
    ...
    parser.add_argument('--revisit_punishment', type=float, default=0.01, help='Revisit punishment')
    parser.add_argument('--local_opt_reward', type=float, default=0.0, help='Local opt reward')
    parser.add_argument('--initialization', type=str, default='greedy', choices=['zeros', 'greedy'], help='Initialization')
    ...
    parser.add_argument('--n_episodes', type=int, default=20, help='n_episodes')
    parser.add_argument('--episode_length', type=int, default=10, help='Episode length')
    parser.add_argument('--train_patience', type=int, default=20, help='Train patience')
    parser.add_argument('--max_train_steps', type=int, default=200, help='Max train steps')
    ...
    parser.add_argument('--model_load_path', type=str, default=f'used_models/', help='Model load path')
